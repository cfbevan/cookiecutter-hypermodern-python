...
Both of these commands should display the latest Python version, 3.11.
...
- `py -X.Y -VV` (e.g. `py -3.11 -VV`) should display the exact version you just installed.
...
```console
$ pyenv local 3.11.0 3.10.2 3.9.10
```
...
- {option}`hide_error_codes <mypy --hide-error-codes>`
